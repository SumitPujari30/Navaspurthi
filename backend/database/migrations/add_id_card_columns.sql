-- Migration: Add ID card and participant columns to registrations table
-- Date: November 2025
-- Description: Adds support for multi-participant registrations and ID card generation
...
COMMENT ON COLUMN registrations.participants IS 'Array of participant objects with their details, photos, and ID card URLs';
COMMENT ON COLUMN registrations.id_card_status IS 'Status of ID card generation: processing, ready, failed, or partial';
COMMENT ON COLUMN registrations.total_participants IS 'Total number of participants in this registration';
